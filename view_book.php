...
$scanPDFs = scandir('uploads/pdfs/'.$book_id.'/');
unset($scanPDFs[0]);
unset($scanPDFs[1]);
?>
<style>
...
<div class="container-fluid" id="book-details">
    ...
    <div class="col-12">
            ...
            <div class="col-1">
                <div class="btn btn btn-primary btn-sm rounded-0" type="button" >
                            
                        <?php if (!empty($scanPDFs)): ?>
                            <?php foreach ($scanPDFs as $pdf): ?>
                                <div class="btn btn btn-primary btn-sm rounded-0" type="button">
                                    <a href="uploads/pdfs/<?php echo $book_id . '/' . $pdf; ?>" target="_blank"><?php echo $pdf; ?></a>
                                </div>
                            <?php endforeach; ?>
                        <?php endif; ?>View
            </div>
...
//    <div class="row justify-content-end">
  ...
  //      <?php foreach ($scanPDFs as $pdf): ?>
      //      <div class="btn btn btn-primary btn-sm rounded-0" type="button">
     //       <a href="uploads/pdfs/<?php echo $book_id . '/' . $pdf; ?>" target="_blank"><?php echo $pdf; ?>View</a>
    //    </div>
    //    <?php endforeach; ?>
   // <?php endif; ?>
     //       </div>