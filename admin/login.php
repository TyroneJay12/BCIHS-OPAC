...
<body class="bg-dark bg-gradient">
   <div class="h-100 d-flex jsutify-content-center align-items-center">
       <div class='w-100'>
        <h3 class="py-5 text-center text-light">BATANGAS CITY INTEGRATED HIGH SCHOOL</h3>
        <h4 class="py-5 text-center text-light">Online Public Access Catalog System - Admin</h4>
